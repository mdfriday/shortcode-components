...
const style_builder_1 = require("./style-builder");
/**
...
class ThemeManagerImpl {
    ...
    constructor(prefix = '') {
         ...
         */
        this.currentTheme = { name: '', mode: 'light' };
        this.prefix = prefix;
        this.componentsRegistry = new components_1.ThemeComponentsRegistry();
    }
    /**
     ...
     */
    register(theme) {
        if (!(0, utils_1.validateTheme)(theme)) {
    ...
    getTheme(name, mode) {
        ...
        if (theme.parent) {
            ...
            return (0, utils_1.mergeThemes)(parentTheme, theme);
        }
        return theme;
    }
    /**
     ...
     */
    getComponentClasses(componentName, props) {
        ...
        if (style_builder_1.StyleBuilderRegistry.hasFactory(builderName)) {
            const factory = style_builder_1.StyleBuilderRegistry.getFactory(builderName, theme);
            ...
            // 处理样式属性
            if (props.variant)
                styleProps.variant = props.variant;
            if (props.textColor)
                styleProps.textColor = props.textColor;
            if (props.backgroundColor)
                styleProps.backgroundColor = props.backgroundColor;
            if (props.borderColor)
                styleProps.borderColor = props.borderColor;
            if (props.size)
                styleProps.size = props.size;
            if (props.width)
                styleProps.width = props.width;
            if (props.height)
                styleProps.height = props.height;
            if (props.border !== undefined)
                styleProps.border = props.border;
            // if (props.rounded !== undefined) styleProps.rounded = props.rounded;
            if (props.outline !== undefined)
                styleProps.outline = props.outline;
            if (props.shadow)
                styleProps.shadow = props.shadow;
            ...
            // 处理布局属性
            if (props.display)
                layoutProps.display = props.display;
            if (props.position)
                layoutProps.position = props.position;
            if (props.gap !== undefined)
                layoutProps.gap = props.gap;
            if (props.padding !== undefined)
                layoutProps.padding = props.padding;
            if (props.paddingX !== undefined)
                layoutProps.paddingX = props.paddingX;
            if (props.paddingY !== undefined)
                layoutProps.paddingY = props.paddingY;
            if (props.margin !== undefined)
                layoutProps.margin = props.margin;
            if (props.cols !== undefined)
                layoutProps.cols = props.cols;
            if (props.rows !== undefined)
                layoutProps.rows = props.rows;
            // 处理排版属性
            if (props.fontFamily)
                typographyProps.fontFamily = props.fontFamily;
            if (props.fontSize)
                typographyProps.fontSize = props.fontSize;
            if (props.fontWeight)
                typographyProps.fontWeight = props.fontWeight;
            if (props.textAlign)
                typographyProps.textAlign = props.textAlign;
            if (props.lineHeight)
                typographyProps.lineHeight = props.lineHeight;
            if (props.letterSpacing)
                typographyProps.letterSpacing = props.letterSpacing;
            if (props.textDecoration)
                typographyProps.textDecoration = props.textDecoration;
            if (props.textTransform)
                typographyProps.textTransform = props.textTransform;
            // 处理动画属性
            if (props.animation)
                animationProps.animation = props.animation;
            if (props.transition)
                animationProps.transition = props.transition;
            if (props.duration)
                animationProps.duration = props.duration;
            if (props.scale !== undefined)
                animationProps.scale = props.scale;
            if (props.rotate !== undefined)
                animationProps.rotate = props.rotate;
            if (props.translate)
                animationProps.translate = props.translate;
            if (props.delay !== undefined)
                animationProps.delay = props.delay;
            if (props.timing)
                animationProps.timing = props.timing;
            // 处理交互属性
            if (props.cursor)
                interactiveProps.cursor = props.cursor;
            if (props.hover)
                interactiveProps.hover = props.hover;
            if (props.focus)
                interactiveProps.focus = props.focus;
            if (props.active)
                interactiveProps.active = props.active;
            if (props.disabled !== undefined)
                interactiveProps.disabled = props.disabled;
            // 处理响应式属性
            if (props.sm)
                responsiveProps.sm = props.sm;
            if (props.md)
                responsiveProps.md = props.md;
            if (props.lg)
                responsiveProps.lg = props.lg;
            if (props.xl)
                responsiveProps.xl = props.xl;
            if (props.hidden)
                responsiveProps.hidden = props.hidden;
            if (props.visible)
                responsiveProps.visible = props.visible;
            // 构建类名
            let classes = builder
